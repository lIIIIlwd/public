...
function jsonToGo(json, typename, flatten = false, example = false, allOmitempty = false) {
    let data;
    let scope;
    let go = "";
    let tabs = 0;
    ...
    try {
        data = JSON.parse(json); // hack that forces floats to stay as floats
        scope = data;
    } catch (e) {
        return {
            go: "",
...
//    console.log("seenTypeNames:", seenTypeNames);
...
//        console.log("..................................................");
    ...
    // Given two types, returns Fthe more specific of the two
...
// let result = jsonToGo(process.argv[2], process.argv[3])
let json = "{\"aaa\":{\"bbb\":[1,2]},\"bbb\":{\"ccc\":{\"aaa\":{\"bbb\":[1,2]}}}}";
let typename = "req";
let result = jsonToGo(json, typename, true);
//console.log("\n\n");
